...
from terrajin.math.noise.gradient_noise.noise import Noise2D


class OpenSimplex2SNoise2D(Noise2D):
    def __call__(self, x: float, y: float) -> float:
        ...
        value = (
            a0 * a0 * a0 * a0
            * gradient_dot(self.seed, hash_x, hash_y, x0, y0)
        )
        ...
        value += (
            a1 * a1 * a1 * a1
            * gradient_dot(self.seed, hash_x1, hash_y1, x1, y1)
        )
